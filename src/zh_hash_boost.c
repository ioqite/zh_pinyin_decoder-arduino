...
const __zh_hash_node_t hash_node_ai = { 1, (uint8_t*)&idx_ai };
const __zh_hash_node_t hash_node_an = { 2, (uint8_t*)&idx_an };
const __zh_hash_node_t hash_node_ao = { 1, (uint8_t*)&idx_ao };
const __zh_hash_node_t hash_node_ba = { 5, (uint8_t*)&idx_ba };
const __zh_hash_node_t hash_node_be = { 3, (uint8_t*)&idx_be };
const __zh_hash_node_t hash_node_bi = { 6, (uint8_t*)&idx_bi };
const __zh_hash_node_t hash_node_bo = { 1, (uint8_t*)&idx_bo };
const __zh_hash_node_t hash_node_bu = { 1, (uint8_t*)&idx_bu };
const __zh_hash_node_t hash_node_ch = { 18,(uint8_t*)&idx_ch };
const __zh_hash_node_t hash_node_cu = { 5, (uint8_t*)&idx_cu };
const __zh_hash_node_t hash_node_ca = { 5, (uint8_t*)&idx_ca };
const __zh_hash_node_t hash_node_ce = { 3, (uint8_t*)&idx_ce };
const __zh_hash_node_t hash_node_ci = { 1, (uint8_t*)&idx_ci };
const __zh_hash_node_t hash_node_co = { 2, (uint8_t*)&idx_co };
const __zh_hash_node_t hash_node_du = { 5, (uint8_t*)&idx_du };
const __zh_hash_node_t hash_node_da = { 5, (uint8_t*)&idx_da };
const __zh_hash_node_t hash_node_de = { 3, (uint8_t*)&idx_de };
const __zh_hash_node_t hash_node_di = { 7, (uint8_t*)&idx_di };
const __zh_hash_node_t hash_node_do = { 2, (uint8_t*)&idx_do };
const __zh_hash_node_t hash_node_en = { 1, (uint8_t*)&idx_en };
const __zh_hash_node_t hash_node_ei = { 1, (uint8_t*)&idx_ei };
const __zh_hash_node_t hash_node_er = { 1, (uint8_t*)&idx_er };
const __zh_hash_node_t hash_node_fa = { 3, (uint8_t*)&idx_fa };
const __zh_hash_node_t hash_node_fe = { 3, (uint8_t*)&idx_fe };
const __zh_hash_node_t hash_node_fo = { 2, (uint8_t*)&idx_fo };
const __zh_hash_node_t hash_node_fu = { 1, (uint8_t*)&idx_fu };
const __zh_hash_node_t hash_node_gu = { 8, (uint8_t*)&idx_gu };
const __zh_hash_node_t hash_node_ga = { 5, (uint8_t*)&idx_ga };
const __zh_hash_node_t hash_node_ge = { 4, (uint8_t*)&idx_ge };
const __zh_hash_node_t hash_node_go = { 2, (uint8_t*)&idx_go };
const __zh_hash_node_t hash_node_hn = { 1, (uint8_t*)&idx_hn };
const __zh_hash_node_t hash_node_hu = { 8, (uint8_t*)&idx_hu };
const __zh_hash_node_t hash_node_ha = { 5, (uint8_t*)&idx_ha };
const __zh_hash_node_t hash_node_he = { 4, (uint8_t*)&idx_he };
const __zh_hash_node_t hash_node_ho = { 2, (uint8_t*)&idx_ho };
const __zh_hash_node_t hash_node_ju = { 3, (uint8_t*)&idx_ju };
const __zh_hash_node_t hash_node_ji = { 10,(uint8_t*)&idx_ji };
const __zh_hash_node_t hash_node_ku = { 8, (uint8_t*)&idx_ku };
const __zh_hash_node_t hash_node_ka = { 5, (uint8_t*)&idx_ka };
const __zh_hash_node_t hash_node_ke = { 3, (uint8_t*)&idx_ke };
const __zh_hash_node_t hash_node_ko = { 2, (uint8_t*)&idx_ko };
const __zh_hash_node_t hash_node_lu = { 5, (uint8_t*)&idx_lu };
const __zh_hash_node_t hash_node_lv = { 1, (uint8_t*)&idx_lv };
const __zh_hash_node_t hash_node_la = { 5, (uint8_t*)&idx_la };
const __zh_hash_node_t hash_node_le = { 3, (uint8_t*)&idx_le };
const __zh_hash_node_t hash_node_li = { 9, (uint8_t*)&idx_li };
const __zh_hash_node_t hash_node_lo = { 3, (uint8_t*)&idx_lo };
const __zh_hash_node_t hash_node_ma = { 5, (uint8_t*)&idx_ma };
const __zh_hash_node_t hash_node_me = { 4, (uint8_t*)&idx_me };
const __zh_hash_node_t hash_node_mi = { 7, (uint8_t*)&idx_mi };
const __zh_hash_node_t hash_node_mo = { 2, (uint8_t*)&idx_mo };
const __zh_hash_node_t hash_node_mu = { 1, (uint8_t*)&idx_mu };
const __zh_hash_node_t hash_node_nu = { 4, (uint8_t*)&idx_nu };
const __zh_hash_node_t hash_node_nv = { 1, (uint8_t*)&idx_nv };
const __zh_hash_node_t hash_node_na = { 5, (uint8_t*)&idx_na };
const __zh_hash_node_t hash_node_ne = { 4, (uint8_t*)&idx_ne };
const __zh_hash_node_t hash_node_ni = { 8, (uint8_t*)&idx_ni };
const __zh_hash_node_t hash_node_ng = { 1, (uint8_t*)&idx_ng };
const __zh_hash_node_t hash_node_no = { 2, (uint8_t*)&idx_no };
const __zh_hash_node_t hash_node_ou = { 1, (uint8_t*)&idx_ou };
const __zh_hash_node_t hash_node_pa = { 5, (uint8_t*)&idx_pa };
const __zh_hash_node_t hash_node_pe = { 3, (uint8_t*)&idx_pe };
const __zh_hash_node_t hash_node_pi = { 6, (uint8_t*)&idx_pi };
const __zh_hash_node_t hash_node_po = { 2, (uint8_t*)&idx_po };
const __zh_hash_node_t hash_node_pu = { 1, (uint8_t*)&idx_pu };
const __zh_hash_node_t hash_node_qu = { 4, (uint8_t*)&idx_qu };
const __zh_hash_node_t hash_node_qi = { 10,(uint8_t*)&idx_qi };
const __zh_hash_node_t hash_node_ru = { 5, (uint8_t*)&idx_ru };
const __zh_hash_node_t hash_node_ra = { 3, (uint8_t*)&idx_ra };
const __zh_hash_node_t hash_node_re = { 3, (uint8_t*)&idx_re };
const __zh_hash_node_t hash_node_ri = { 1, (uint8_t*)&idx_ri };
const __zh_hash_node_t hash_node_ro = { 2, (uint8_t*)&idx_ro };
const __zh_hash_node_t hash_node_sh = { 18,(uint8_t*)&idx_sh };
const __zh_hash_node_t hash_node_su = { 5, (uint8_t*)&idx_su };
const __zh_hash_node_t hash_node_sa = { 5, (uint8_t*)&idx_sa };
const __zh_hash_node_t hash_node_se = { 3, (uint8_t*)&idx_se };
const __zh_hash_node_t hash_node_si = { 1, (uint8_t*)&idx_si };
const __zh_hash_node_t hash_node_so = { 2, (uint8_t*)&idx_so };
const __zh_hash_node_t hash_node_tu = { 5, (uint8_t*)&idx_tu };
const __zh_hash_node_t hash_node_ta = { 5, (uint8_t*)&idx_ta };
const __zh_hash_node_t hash_node_te = { 3, (uint8_t*)&idx_te };
const __zh_hash_node_t hash_node_ti = { 5, (uint8_t*)&idx_ti };
const __zh_hash_node_t hash_node_to = { 2, (uint8_t*)&idx_to };
const __zh_hash_node_t hash_node_wa = { 4, (uint8_t*)&idx_wa };
const __zh_hash_node_t hash_node_we = { 3, (uint8_t*)&idx_we };
const __zh_hash_node_t hash_node_wo = { 1, (uint8_t*)&idx_wo };
const __zh_hash_node_t hash_node_wu = { 1, (uint8_t*)&idx_wu };
const __zh_hash_node_t hash_node_xu = { 4, (uint8_t*)&idx_xu };
const __zh_hash_node_t hash_node_xi = { 10,(uint8_t*)&idx_xi };
const __zh_hash_node_t hash_node_yu = { 4, (uint8_t*)&idx_yu };
const __zh_hash_node_t hash_node_ya = { 4, (uint8_t*)&idx_ya };
const __zh_hash_node_t hash_node_ye = { 1, (uint8_t*)&idx_ye };
const __zh_hash_node_t hash_node_yi = { 3, (uint8_t*)&idx_yi };
const __zh_hash_node_t hash_node_yo = { 3, (uint8_t*)&idx_yo };
const __zh_hash_node_t hash_node_zu = { 5, (uint8_t*)&idx_zu };
const __zh_hash_node_t hash_node_za = { 5, (uint8_t*)&idx_za };
const __zh_hash_node_t hash_node_ze = { 4, (uint8_t*)&idx_ze };
const __zh_hash_node_t hash_node_zi = { 1, (uint8_t*)&idx_zi };
const __zh_hash_node_t hash_node_zo = { 2, (uint8_t*)&idx_zo };
const __zh_hash_node_t hash_node_zh = { 20,(uint8_t*)&idx_zh };
